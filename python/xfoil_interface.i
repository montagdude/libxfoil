...
extern void xfoil_defaults(xfoil_data_group *xdg,
                           xfoil_options_type *xfoil_options, int *stat);
...
extern void xfoil_geometry_info(xfoil_data_group *xdg, double *maxt,
                                ...
                                int *stat);
extern void xfoil_set_reynolds_number(xfoil_data_group *xdg, double *re);
extern void xfoil_set_mach_number(xfoil_data_group *xdg, double *mach);
extern void xfoil_reinitialize_bl(xfoil_data_group *xdg);
extern void xfoil_specal(xfoil_data_group *xdg, double *alpha_spec,
                         double *alpha, double *lift, double *drag,
                         double *moment, bool *converged, int *stat);
extern void xfoil_speccl(xfoil_data_group *xdg, double *cl_spec,
                         double *alpha, double *lift, double *drag,
                         double *moment, bool *converged, int *stat);
extern void xfoil_get_transloc(xfoil_data_group *xdg, double *xtranst,
                               double *ztranst, double *xtransb,
                               double *ztransb, int *stat);
extern void xfoil_get_cp(xfoil_data_group *xdg, int *npoint, double *cp,
                         int *stat);
extern void xfoil_get_cf(xfoil_data_group *xdg, int *npoint, double *cf,
                         int *stat);
extern void xfoil_get_uedge(xfoil_data_group *xdg, int *npoint, double *uedge,
                            int *stat);
extern void xfoil_get_deltastar(xfoil_data_group *xdg, int *npoint,
                                double *deltastar, int *stat);
extern void xfoil_get_diss(xfoil_data_group *xdg, int *npoint, double *diss,
                           int *stat);
...
extern void run_xfoil(int *npointin, double *xin, double *zin,
                      xfoil_geom_options_type *geom_opts, int *noppoint,
                      double *operating_points, int *op_modes,
                      double *reynolds_numbers, double *mach_numbers,
                      bool *use_flap, double *x_flap, double *z_flap,
                      int *z_flap_spec, double *flap_degrees,
                      xfoil_options_type *xfoil_opts, bool *reinitialize,
